...
FirebaseAuth mAuth= FirebaseAuth.getInstance();
    //public String uid=mAuth.getCurrentUser().getUid();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(id!=null && !id.isEmpty() ){
            try{
                ...
                BitMatrix bm=mw.encode(id, BarcodeFormat.QR_CODE,100,100);
        ...
        db.get()
                .addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                    ...
                    public void onSuccess(DocumentSnapshot documentSnapshot) {
                        ...
                        {
                            Toast.makeText(scan_activity.this,"Document doesnt exists",Toast.LENGTH_SHORT).show();
                        }
                    }
                })
        .addOnFailureListener(new OnFailureListener() {
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(scan_activity.this,e.getMessage(),Toast.LENGTH_SHORT).show();
            }
        });
        ...
        set.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent in =new Intent(scan_activity.this,m2.class);
                startActivity(in);
            }
        });
        ...
        view.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in =new Intent(scan_activity.this,photos.class);
                startActivity(in);
            }
        });
        String pid= mem.getPhoto();
